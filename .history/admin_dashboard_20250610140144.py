...
def view_reports(self):
    ...
    ttk.Button(button_frame, text="📄 Generate Report", style="Big.TButton", command=lambda: fetch_report()).pack(side=tk.LEFT, padx=10)
    ...
    ttk.Button(button_frame, text="💾 Save Report", style="Big.TButton", command=lambda: generate_report(save_to_file=True)).pack(side=tk.LEFT, padx=10)
    ttk.Button(button_frame, text="🖨 Print Report", style="Big.TButton", command=lambda: print_report()).pack(side=tk.LEFT, padx=10)
