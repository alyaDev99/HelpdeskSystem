...
class AdminDashboard:
    ...
    def view_reports(self):
        ...
        ttk.Button(button_frame, text="📄 Generate Report", command=fetch_report).pack(side=tk.LEFT, padx=5)
        ...
        ttk.Button(button_frame, text="💾 Save Report", command=lambda: generate_report(save_to_file=True)).pack(side=tk.LEFT, padx=5)
        ttk.Button(button_frame, text="🖨 Print Report", command=print_report).pack(side=tk.LEFT, padx=5)
