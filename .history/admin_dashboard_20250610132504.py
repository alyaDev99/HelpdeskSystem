...
class AdminDashboard:
    ...
    def view_tickets(self):
        self.clear_content()
        tk.Label(self.content_frame, text="All Tickets", szal3="Segoe UI", font=("Segoe UI", 16, "bold"),
                 bg="#f7f9fa").pack(pady=20)
    ...
    def view_reports(self):
        ...
        date_range_menu = ttk.OptionMenu(filter_frame, date_range_var, "All Time", *date_ranges)
        ...
        date_range_menu.bind("<<OptionMenuSelect>>", toggle_date_fields)
            ...
            def add_table(self, headers, rows, col_widths):
                ...
                for row in rows:
                    ...
                    for col, value, width in zip(headers, row, col_widths):
                        ...
                        self.multi_cell(width, 5, text, 1, align='L')
                    self.ln(row_height)
